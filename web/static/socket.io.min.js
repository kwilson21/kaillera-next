          ...
          try {
            ...
            try {
              if (this.l.extraHeaders)
                for (var o in (e.setDisableHeaderCheck && e.setDisableHeaderCheck(!0), this.l.extraHeaders))
            ...
            (null === (t = this.l.cookieJar) || void 0 === t || t.addCookies(e),
              ...
              (e.onreadystatechange = function () {
                var t;
                (3 === e.readyState &&
                  (null === (t = i.l.cookieJar) || void 0 === t || t.parseCookies(e.getResponseHeader('set-cookie'))),
                  4 === e.readyState &&
    ...
    return (
      ...
      (i.q = function () {
        ...
        if (0 !== this.transports.length) {
          var i =
            this.opts.rememberUpgrade && n.priorWebsocketSuccess && -1 !== this.transports.indexOf('websocket')
              ? 'websocket'
              : this.transports[0];
        ...
        (n.isPayloadValid = function (t, n) {
          switch (t) {
            ...
            case Bt.BINARY_EVENT:
              return (
                Array.isArray(n) && ('number' == typeof n[0] || ('string' == typeof n[0] && -1 === St.indexOf(n[0])))
              );
            case Bt.ACK:
            case Bt.BINARY_ACK:
  ...
  var Rt = Object.freeze({
    ...
    Lt = (function (t) {
      ...
      return (
        ...
        (o.connect = function () {
          return (
            this.connected || (this.subEvents(), this.io.ot || this.io.open(), 'open' === this.io.st && this.onopen()),
            this
          );
        }),
        (o.open = function () {
        ...
        (o.emit = function (t) {
          ...
          var c =
              null === (i = null === (n = this.io.engine) || void 0 === n ? void 0 : n.transport) || void 0 === i
                ? void 0
                : i.writable,
